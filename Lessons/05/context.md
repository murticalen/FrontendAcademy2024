Demonstrate how data can be passed via context by creating `QuestionContext` which will provide data to child components instead of passing it via props.
